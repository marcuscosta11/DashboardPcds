...
function getStatusPcdsPluvioMap(){
     $.ajax({
        async: true,
        global: false,        
        url: "http://localhost:8081/DashboardWS-1.0-SNAPSHOT/rest/message/getJsonStatusPcdsPluvio",
...
function getPcdsInativasOperadorasPluvio(){
     $.ajax({
        async: true,
        global: false,        
        url: "http://localhost:8081/DashboardWS-1.0-SNAPSHOT/rest/message/getJsonPcdsInativasOperadora",
